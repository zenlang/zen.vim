...
syn keyword zenStorage const var extern packed export pub noalias inline noinline comptime volatile allowzero align linksection threadlocal vtable terminate deprecated callconv mut
